              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-200 rounded-lg p-4 md:p-6 text-center hover:border-blue-600 transition-colors cursor-pointer">
                    ...
                    <p className="text-xs text-gray-500">National ID, Driver's License, or Passport</p>
                  </div>
                </div>

                {/* Proof of Address */}
                <div>
                  <Label className="text-xs md:text-sm font-medium text-gray-700 mb-2 block">Proof of Address</Label>
                  <div className="border-2 border-dashed border-gray-200 rounded-lg p-4 md:p-6 text-center hover:border-blue-600 transition-colors cursor-pointer">
                    <Upload className="h-6 w-6 md:h-8 md:w-8 text-gray-400 mx-auto mb-2" />
                    <p className="text-xs md:text-sm text-gray-600 mb-1">Click to upload or drag and drop</p>
                ...
                {/* Selfie */}
                <div>
                  <Label className="text-xs md:text-sm font-medium text-gray-700 mb-2 block">Selfie with ID</Label>
                  <div className="border-2 border-dashed border-gray-200 rounded-lg p-4 md:p-6 text-center hover:border-blue-600 transition-colors cursor-pointer">
