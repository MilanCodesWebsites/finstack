...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    ...
    description: "Instant transfers in minutes, not days",
    label: "Speed",
    icon: "Zap",
  },
  {
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-2 max-w-[68rem] select-none relative w-full"
...
const renderIcon = (iconName?: string) => {
  const iconProps = { className: "w-8 h-8 md:w-10 md:h-10", strokeWidth: 1.5 }
          ...
          {cardData.map((card, index) => {
            ...
            const cardStyle = {
              ...
              backgroundImage: card.backgroundImage
                ? `linear-gradient(rgba(6, 0, 16, 0.85), rgba(6, 0, 16, 0.85)), url(${card.backgroundImage})`
                : "none",
