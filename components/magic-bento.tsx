      ...
      <style>
        {`
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            /* Updated color variables to use blue theme instead of purple */
            --blue-primary: rgba(47, 103, 250, 1);
            --blue-glow: rgba(47, 103, 250, 0.2);
            --blue-border: rgba(47, 103, 250, 0.8);
          }
          ...
          /* Added background image and dark overlay styles */
          .card-with-bg {
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card card-with-bg flex flex-col justify-between relative aspect-[4/3] min-h-[200px] w-full max-w-full p-5 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${
